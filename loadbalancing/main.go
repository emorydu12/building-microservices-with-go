...
// RandomStrategy implements Strategy for random endpoints selection
...
// GetEndpoints gets an endpoint based on the given strategy
func (l *LoadBalancer) GetEndpoints() url.URL {
